...
# Mastering Plone Votable Add-on build configuration file
...
project = "Mastering Plone Votable Add-on"
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/masteringplonevotableadd_on/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/masteringplonevotableadd_on",
    ...
    "logo": {
        "text": "Mastering Plone Votable Add-on",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://github.com/collective/masteringplonevotableadd_on",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/masteringplonevotableadd_on/edit/main/docs/",
# }
...
ogp_site_name = "Mastering Plone Votable Add-on Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Mastering Plone Votable Add-onDocumentation"
...
latex_documents = [
    (
        "index",
        "Mastering Plone Votable Add-onDocumentation.tex",
        "Mastering Plone Votable Add-on Documentation",
