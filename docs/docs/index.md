...
myst:
  html_meta:
    "description": "An example add-on with a votable behavior"
    "property=og:description": "An example add-on with a votable behavior"
    "property=og:title": "Mastering Plone Votable Add-on"
    "keywords": "Mastering Plone Votable Add-on, documentation, An example add-on with a votable behavior"
---

# Mastering Plone Votable Add-on

Welcome to the documentation for Mastering Plone Votable Add-on!
